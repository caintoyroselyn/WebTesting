...
${opencontexmenu}=  //span[@class="context-menu-one btn btn-neutral"]
${doubleclick}=     //button[@ondblclick="myFunction1()"]
${dragelement}=     //div[@id="DHTMLgoodies_dragableElement0"]
${dropelement}=     (//div[@class="dragableBoxRight"])[1]